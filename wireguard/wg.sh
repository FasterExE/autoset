...
# ==================================================
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/givpn/autoset/master/wireguard"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/givpn/autoset/master/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/givpn/autoset/master/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/givpn/autoset/master/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
